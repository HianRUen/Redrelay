...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body>
        <main class="min-h-screen flex flex-col justify-between">
            <div>
                <nav id="navbar" style="background-color:#000;" class="block py-6 w-full max-w-full transition-all sticky top-0 z-40 px-6 bg-gray-100">
                    <div class="max-w-[1200px] w-full h-10 mx-auto flex items-center justify-between">
                        <a class="flex items-center" href="/">
                            <img src="https://redrelay.net/assets/logo/redrelay.svg"/>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 md:gap-16 pb-10 border-b border-gray-300">
                        <div>
                            <div class="flex items-center mb-6">
                                 <img src="https://redrelay.net/assets/logo/bg-d.svg"/>
                        ...
                        <div class="grid grid-cols-12 gap-16 md:gap-4">
                            ...
                            <div class="col-span-12 md:col-span-5">
                                <p class="font-bold text-gray-900 mb-6">Useful Links</p>
